...
### (Offline reactive policy search)

Model predictions are used to improve the policy **outside** the main environment interaction loop.

---

## 🔹 A. Policy Training (Dyna-style updates)

Synthetic rollouts generated by the model are inserted into the replay buffer to speed up learning.
